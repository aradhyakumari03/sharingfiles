This file sharing system is Framework - django rest Framework Database - MySQL Created a secure file-sharing system between two different types of users. 
For implementation - I have created a REST API’s for the following action. User 1: Operation User Actions which could be done by an Ops User
